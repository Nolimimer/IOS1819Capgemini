...
class ScannedObject: SCNNode {
    ...
    private(set) var boundingBox: ScanBoundingBox?
    private(set) var ghostBoundingBox: ScanBoundingBox?
    ...
    var eitherBoundingBox: ScanBoundingBox? {
    ...
    func createBoundingBox(screenPos: CGPoint) {
        ...
        let boundingBox = ScanBoundingBox(sceneView)
        self.boundingBox = boundingBox
