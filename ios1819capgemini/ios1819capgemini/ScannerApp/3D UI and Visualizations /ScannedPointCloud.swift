...
class ScannedPointCloud: SCNNode, PointCloud {
    ...
    private var boundingBox: ScanBoundingBox?
    ...
    func updateBoundingBox(_ boundingBox: ScanBoundingBox?) {
        self.boundingBox = boundingBox
    }
    
    func update(with pointCloud: ARPointCloud, localFor boundingBox: ScanBoundingBox) {
